from PyQt6.QtWidgets import QHBoxLayout, QGridLayout, QLabel, QGroupBox, QDoubleSpinBox, QSlider
...
class DeviceSettingsPanel(QGroupBox):
    ...
    def __init__(
        ...
        super().__init__(f"{device_name} Settings", parent)
            ...
            if widget_type == 'text': 
                ...
                for idx, val in enumerate(value): 
                    ...
                    widget.valueChanged.connect(
                        lambda val, multiplier = multiplier, param = param, idx=idx: self.update_param(
